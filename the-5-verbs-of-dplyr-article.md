...
Notice that first the mean of the hamster\_cages column is calculated to be 2.6, then the new column is created by subtracting 2.6 off of each value of the hamster\_cages column.
